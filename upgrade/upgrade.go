...
import (
	...
	"github.com/MostafaSensei106/Code-Choki/internal/platform"
)

const repoURL = "https://github.com/MostafaSensei106/Code-Choki.git"

// upgradeDirectory returns the path to the upgrade directory where
// the CodeChoki repository is cloned for upgrading. It is located in the
// user's home directory under ".CodeChoki/upgrade". If the home directory
...
func upgradeDirectory() string {
	...
	return filepath.Join(homeDir, ".CodeChoki/upgrade")
}
